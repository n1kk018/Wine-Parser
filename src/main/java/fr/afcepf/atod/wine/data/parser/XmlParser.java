...
public class XmlParser {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            daoCountry.insertObj(new Country(null,"BG", "Bulgarie", "BGN", "flaticon-bulgaria-lev"));
            daoCountry.insertObj(new Country(null,"CY", "Chypre", "EUR", "flaticon-euro-currency-symbol"));
            daoCountry.insertObj(new Country(null,"CZ", "République Tchèque", "CZK", "flaticon-czech-republic-koruna-currency-symbol"));
            daoCountry.insertObj(new Country(null,"DE", "Allemagne", "EUR", "flaticon-euro-currency-symbol"));
            daoCountry.insertObj(new Country(null,"DK", "Danemark", "DKK", "flaticon-denmark-krone-currency-symbol"));
            daoCountry.insertObj(new Country(null,"EE", "Estonie", "EEK", "flaticon-estonia-kroon-currency-symbol"));
            daoCountry.insertObj(new Country(null,"ES", "Espagne", "EUR", "flaticon-euro-currency-symbol"));
            daoCountry.insertObj(new Country(null,"FI", "Finlande", "EUR", "flaticon-euro-currency-symbol"));
            daoCountry.insertObj(new Country(null,"GB", "Royaume-Uni", "GBP", "flaticon-pound-symbol-variant"));
            daoCountry.insertObj(new Country(null,"GR", "Grèce", "EUR", "flaticon-euro-currency-symbol"));
            daoCountry.insertObj(new Country(null,"HU", "Hongrie","HUF","flaticon-hungary-forint-currency-symbol"));
            daoCountry.insertObj(new Country(null,"IE", "Irlande", "EUR", "flaticon-euro-currency-symbol"));
            daoCountry.insertObj(new Country(null,"IT", "Italie", "EUR", "flaticon-euro-currency-symbol"));
            daoCountry.insertObj(new Country(null,"JP", "Japon", "JPY", "flaticon-yen-currency-symbol"));
            daoCountry.insertObj(new Country(null,"LT", "Lituanie", "LTL", "flaticon-lithuania-litas-currency-symbol"));
            daoCountry.insertObj(new Country(null,"LU", "Luxembourg", "EUR", "flaticon-euro-currency-symbol"));
            daoCountry.insertObj(new Country(null,"LV", "Lettonie", "LVL", "flaticon-latvia-lat"));
            daoCountry.insertObj(new Country(null,"MT", "Malte", "EUR", "flaticon-euro-currency-symbol"));
            daoCountry.insertObj(new Country(null,"NL", "Pays-Bas", "EUR", "flaticon-euro-currency-symbol"));
            daoCountry.insertObj(new Country(null,"PL", "Pologne", "PLN", "flaticon-poland-zloty-currency-symbol"));
            daoCountry.insertObj(new Country(null,"PT", "Portugal", "EUR", "flaticon-euro-currency-symbol"));
            daoCountry.insertObj(new Country(null,"RO", "Roumanie", "EUR", "flaticon-euro-currency-symbol"));
            daoCountry.insertObj(new Country(null,"SE", "Suède", "SEK", "flaticon-sweden-krona-currency-symbol"));
            daoCountry.insertObj(new Country(null,"SI", "Slovénie", "EUR", "flaticon-euro-currency-symbol"));
            daoCountry.insertObj(new Country(null,"SK", "Slovaquie", "EUR", "flaticon-euro-currency-symbol"));
            daoCountry.insertObj(new Country(null,"US", "Etats-Unis", "USD", "flaticon-dollar-currency-symbol-2"));
            daoCountry.insertObj(new Country(null,"FR","France", "EUR", "flaticon-euro-currency-symbol"));
